...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="radio" name="pname0" value="" checked/>否&nbsp;&nbsp;&nbsp;
            <input type="radio" name="pname0" value=""/>是</td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">性别</td>
        <td><input type="radio" name="pname" value="" checked/>男&nbsp;&nbsp;&nbsp;
            <input type="radio" name="pname" value=""/>女</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="radio" name="pname1" value="" checked/>初诊&nbsp;&nbsp;&nbsp;
            <input type="radio" name="pname1" value=""/>复诊</td>
    </tr>
    <tr>
