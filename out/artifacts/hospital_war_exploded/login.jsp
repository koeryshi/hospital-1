...
.login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(html/images/mask.png);border-radius:10px;}
...
<div class="login-box">
	...
	<form method="post" action="index.jsp">
		...
		<div class="code">
			...
			<div class="codeImg">
				<img src="html/images/captcha.jpeg.jpg" />
			</div>
		</div>
		<div class="remember">
...
<div class="bottom">©2014 Leting <a href="javascript:;" target="_blank">关于</a> <span>京ICP证030173号</span><img width="13" height="16" src="html/Images/copy_rignt_24.png" /></div>

<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="html/Images/01.jpg"></a></li>
