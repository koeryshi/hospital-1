...
<body>
<form action="${pageContext.request.contextPath}/Chargeproject/chargeprojectAdd" method="post" class="definewidth m20">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">编号</td>
        <td><input type="text" name="cmid" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="cmmoney"/></td>
    </tr>
    <tr>
        <td colspan="2">
			<center>
